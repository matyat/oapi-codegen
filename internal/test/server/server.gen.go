...
//
// Code generated by github.com/matyat/oapi-codegen version (devel) DO NOT EDIT.
package server
...
type EveryTypeOptional struct {
	...
	DateField            *openapi_types.Date `json:"date_field,omitempty" xml:"date_field"`
...
type GetWithArgsParams struct {
	...
	OptionalArgument *int64 `json:"optional_argument,omitempty" xml:"optional_argument"`
...
type CreateResource2Params struct {
	// Some query argument
	InlineQueryArgument *int `json:"inline_query_argument,omitempty" xml:"inline_query_argument"`
}
